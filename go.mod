module github.com/joeyloman/rancher-fip-cluster-manager
...
require (
	...
	github.com/rancher/rancher/pkg/apis v0.0.0-20251030043856-07a95705af7d
...
require (
	...
	github.com/rancher/ali-operator v0.0.6 // indirect
